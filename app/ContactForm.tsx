...
Produto: ${formData.productType || 'Não informado'}
    ...
    <section id="contato" className="py-20 bg-gray-50">
      <div className="container mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-gray-900 mb-4">Faça seu Pedido</h2>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Entre em contato conosco para criar o doce perfeito para sua ocasião especial
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-12">
          <div className="bg-white rounded-2xl shadow-xl p-8 lg:col-span-2">
            <form id="contact-form" onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label className="block text-gray-700 font-semibold mb-2">Data do Evento</label>
                <input
                  type="date"
                  name="eventDate"
              ...
              <div>
                <label className="block text-gray-700 font-semibold mb-2">Número de Convidados</label>
                <input
                  type="number"
                  name="guests"
              ...
              <div>
                <label className="block text-gray-700 font-semibold mb-2">Tipo de Produto</label>
                <select
                  name="productType"
              ...
              <div>
                <label className="block text-gray-700 font-semibold mb-2">Orçamento Aproximado</label>
                <select
                  name="budget"
                  className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:border-pink-500 text-sm pr-8"
                >
              ...
              <div className="md:col-span-2">
                <label className="block text-gray-700 font-semibold mb-2">
                  Mensagem Adicional 
                  <span className="text-sm text-gray-500">({formData.message.length}/500 caracteres)</span>
                </label>
                <textarea
                  name="message"
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">Rua das Flores, 123<br/>Bairro Centro, Belém - PA</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-6">
          <h3 className="text-xl font-bold text-gray-900 mb-4 text-center">Nossa Localização</h3>
