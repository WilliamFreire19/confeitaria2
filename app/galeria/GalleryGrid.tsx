  ...
  return (
    <div className="container mx-auto px-6 py-12">
      ...
      {selectedImage && (
        ...
        >
          <div className="relative w-full max-w-6xl my-8 bg-white rounded-2xl overflow-hidden" onClick={(e) => e.stopPropagation()}>
            <button
              onClick={() => setSelectedImage(null)}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
              ...
              <div className="p-4 sm:p-6 lg:p-8 space-y-4 lg:space-y-6">
                <div>
                  <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-2">{selectedImage.title}</h3>
                  <div className="text-xl sm:text-2xl font-bold text-pink-600">{selectedImage.price}</div>
                </div>
                ...
                <div className="space-y-3 lg:space-y-4">
                  <div>
                    ...
                    <p className="text-gray-600 ml-9 text-sm sm:text-base">{selectedImage.flavor}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 ml-9 text-sm sm:text-base">{selectedImage.frosting}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 ml-9 text-sm sm:text-base">{selectedImage.details}</p>
                  </div>
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 ml-9 text-sm sm:text-base">{selectedImage.serves}</p>
                  </div>
                </div>
                ...
                <div className="pt-4 border-t">
                  <button 
                    ...
                    className="w-full bg-pink-600 hover:bg-pink-700 text-white py-3 px-6 rounded-lg font-semibold transition-colors whitespace-nowrap cursor-pointer text-sm sm:text-base"
                  >
                    Solicitar Orçamento
                  </button>
                </div>
